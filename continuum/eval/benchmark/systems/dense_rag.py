...
from continuum.embed.retrieval import DenseRetriever
...
class DenseRAGSystem:
    ...
    def __init__(self, corpus: BenchmarkCorpus, *, model_name: str = "all-MiniLM-L6-v2") -> None:
        self._corpus = corpus
        provider = SentenceTransformerProvider(model_name=model_name)
        self._retriever = DenseRetriever(provider, corpus.texts)
