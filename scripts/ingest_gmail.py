#!/usr/bin/env python3
"""Ingest Gmail records into canonical Artifact JSONL."""
...
DEFAULT_CURSOR = Path(__file__).resolve().parents[1] / "data" / "ingestion" / "gmail.cursor.json"


def main() -> int:
    parser = argparse.ArgumentParser(description="Ingest Gmail into canonical Artifacts")
